...
# Clonar la carpeta específica del repositorio de GitHub
git clone --depth 1 --filter=blob:none --sparse https://github.com/DereckAn/minecraft
cd minecraft
git sparse-checkout set difficul_af
